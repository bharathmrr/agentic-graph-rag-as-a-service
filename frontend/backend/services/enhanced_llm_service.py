...
class EnhancedLLMService:
    ...
    def _initialize_services(self):
        ...
        try:
            ...
            if self.config.provider == "gemini" and GEMINI_AVAILABLE:
                ...
                logger.warning(f"Provider {self.config.provider} not available, falling back to mock")
                self._init_mock()
    ...
    def _init_ollama_embeddings(self):
        ...
        try:
            ...
            logger.info(f"✅ Ollama embeddings initialized: {self.config.embedding_model}")
        except Exception as e:
    ...
    async def generate_ontology(self, text: str, progress_callback=None) -> Dict[str, Any]:
    ...
    async def extract_entities(self, text: str, progress_callback=None) -> Dict[str, Any]:
    ...
    async def generate_embeddings(self, texts: List[str], progress_callback=None) -> Dict[str, Any]:
        ...
        try:
            ...
            for i, text in enumerate(texts):
                if progress_callback:
                    ...
                    await progress_callback(progress, 100, f"🔢 Generating embeddings... ({i+1}/{total_texts})")
    ...
    async def chat_response(self, query: str, context: str = "", progress_callback=None) -> Dict[str, Any]:
