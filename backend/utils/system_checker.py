...
class SystemChecker:
    ...
    def check_python_version(self) -> Tuple[bool, str]:
        ...
        if version.major >= 3 and version.minor >= 9:
            pipeline_logger.log_system_check("Python Version", True, f"{version.major}.{version.minor}.{version.micro}")
            return True, f"Python {version.major}.{version.minor}.{version.micro}"
        else:
            pipeline_logger.log_system_check("Python Version", False, f"Required: 3.9+, Found: {version.major}.{version.minor}")
    ...
    def check_package_installed(self, package_name: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            pipeline_logger.log_system_check(f"Package: {package_name}", True, f"Version: {version}")
            return True, version
        except ImportError:
            pipeline_logger.log_system_check(f"Package: {package_name}", False, "Not installed")
    ...
    def check_llm_connectivity(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            pipeline_logger.log_system_check("LLM Connectivity", True, "OpenAI client initialized")
    ...
    def check_embedding_service(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            pipeline_logger.log_system_check("Embedding Service", True, "ChromaDB client initialized")
    ...
    def check_neo4j_connection(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            pipeline_logger.log_system_check("Neo4j Connection", True, "Neo4j driver initialized")
